...
// Converter no longer needed; enum parses from string
using DiscordEmotify.Cli.Commands.Shared;
...
public class GetChannelsCommand : DiscordCommandBase
{
    ...
    [CommandOption(
        "include-threads",
        Description = "Which types of threads should be included. Values: none, active, all."
    )]
