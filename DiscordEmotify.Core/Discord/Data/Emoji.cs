...
)
{
    ...
    public static Emoji FromCode(string code)
    {
        // Map :code: style to Unicode if known, otherwise leave as-is
        var unicode = EmojiIndex.TryGetName(code) ?? code;
        return new Emoji(null, unicode, false);
    }
}
