...
namespace DiscordEmotify.Gui;

public static class Program
{
    private static Assembly Assembly { get; } = Assembly.GetExecutingAssembly();

    public static string Name { get; } = Assembly.GetName().Name ?? "DiscordEmotify";
    ...
    public static string ProjectUrl { get; } = "https://github.com/Otm02/DiscordEmotify";
